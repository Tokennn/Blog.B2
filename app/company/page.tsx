      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="company-grid grid lg:grid-cols-2 gap-12 mb-20">
          <div className="company-card bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-white/50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">TechCorp Innovation</h2>
                <p className="text-gray-400">Leader en transformation digitale</p>
              </div>
            </div>
            <p className="text-gray-300 leading-relaxed mb-6">
              TechCorp est une entreprise innovante spécialisée dans la transformation digitale 
              des entreprises. Nous accompagnons nos clients dans leur évolution technologique 
              avec des solutions sur-mesure et une expertise reconnue.
            </p>
            <div className="flex flex-wrap gap-3">
              {['Innovation', 'Excellence', 'Collaboration', 'Impact'].map((value) => (
          ...
          <div className="company-card bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-white/50 transition-all duration-300">
            ...
            <div className="space-y-4 text-gray-300">
              <div className="flex items-start">
                ...
                <p><strong className="text-white">Équipe dynamique</strong> de 150+ collaborateurs passionnés</p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p><strong className="text-white">Bureaux modernes</strong> dans le cœur de Paris avec espaces collaboratifs</p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p><strong className="text-white">Culture d'innovation</strong> avec hackathons et projets internes</p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p><strong className="text-white">Flexibilité</strong> avec télétravail et horaires adaptables</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="stats-section bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm p-12 rounded-2xl border border-gray-600 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { number: '150+', label: 'Collaborateurs', icon: Users },
        ...
        <div className="company-card bg-gray-900/50 backdrop-blur-sm p-12 rounded-2xl border border-gray-700">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-gray-300 leading-relaxed">
            <p>
              Dans un environnement technologique en constante évolution, TechCorp se positionne comme 
              un acteur clé de la transformation digitale. Notre approche collaborative et notre culture 
              d'innovation permettent de relever les défis les plus complexes.
            </p>
            <p>
              Mon rôle au sein de cette équipe exceptionnelle me permet de développer des solutions 
              innovantes tout en bénéficiant d'un cadre stimulant qui favorise l'épanouissement 
